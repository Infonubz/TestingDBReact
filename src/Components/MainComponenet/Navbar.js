  ...
  `}
      ...
      `}
          ...
          <button
            ...
            onClick={() => {
              setSorting(sorting === "arrivalSort" ? "" : "arrivalSort");
              handleSortingClick("arrivalSort");
            }}
          >
            <span className="flex items-center justify-center">
              <p
          ...
          <button
            ...
            onClick={() => {
              setSorting(sorting === "departureSort" ? "" : "departureSort");
              handleSortingClick("departureSort");
            }}
          >
            <span className="flex items-center justify-center">
              <p
        ...
        <div className={`${sidebarToggle ? "col-span-2 " : "col-span-4 "}`}>
          ...
          >
            ...
            <span className="text-[#1F487C] font-bold  text-[0.8vw]  px-[0.1vw] flex items-center">
              ...
              <span className="pr-[0.2vw] text-[1vw] font-extrabold">
                {bus_count?.length}
              </span>
