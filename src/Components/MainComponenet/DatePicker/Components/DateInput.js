        ...
        <>
          ...
          >
            <span className="justify-center flex">
              <CiCalendar size={"1.5vw"} color={`${showPopup ? "white" : "black"}`} />
            </span>
            <p className={`text-center text-[1vw] ${showPopup ? "text-white" : "text-black"}`}>Date</p>
          </div>
          {/* ----------------------------------------------------------MOBILE VIEW------------------------------------------------------------------------------------------- */}
          <div
            className={`${location.pathname == "/" ? "block" : "hidden"
          ...
          >
            <div className="">
              <span className="justify-center flex">
                <CiCalendar size={"5vw"} color={`${showPopup ? "white" : "black"}`} />
              </span>
            </div>
            <p className={`text-center text-[2.5vw] ${showPopup ? "text-white" : "text-black"} `}>Date</p>
          </div>
          {/* ----------------------------------------------------------MOBILE VIEW------------------------------------------------------------------------------------------- */}
        </>
