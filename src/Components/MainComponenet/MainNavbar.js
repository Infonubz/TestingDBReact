    ...
    <>
              ...
              <div className="md:block hidden">
                ...
                >
                  <a onClick={(e) => e.preventDefault()}>
                    <Space>
                      <img src={profile} className="h-[2vw] w-[2vw]" />
                    </Space>
                  </a>
                </Dropdown>
              </div>
      ...
      >
        <div className=" flex flex-col items-center gap-y-[5vw]">
          ...
          <button className=" bg-[#1F487C] text-[4vw] w-3/4 h-[10vw] text-white rounded-md font-bold">
            Yes, Log Out
          </button>
      ...
      >
        <div className=" flex flex-col items-center gap-y-[1vw]">
          ...
          <button className=" bg-[#1F487C] text-[1.4vw] w-[20vw] h-[3.5vw] text-white rounded-full font-bold ">
            Yes, Log Out
          </button>
