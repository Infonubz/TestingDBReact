      ...
      <div className="md:block hidden w-full">
        <div className="bg-[#F6F6F6] h-auto px-[5vw]">
          <div className="flex border-[0.15vw] border-[#1F487C] w-[60vw] rounded-[0.2vw]">
            ...
            >
              <span
                className={`${isToggleSwitch == "CDCP" ? "text-[#F6F6F6]" : "text-[#1F4B7F]"
                  }  text-[1.3vw]`}
              >
            ...
            <button
              className={`${isToggleSwitch == "TRP" ? "bg-[#1F4B7F]" : "bg-[#F6F6F6]"
                } w-[30vw] h-[2.5vw] flex px-[1vw] justify-center gap-[0.5vw] items-center`}
              onClick={() => setIsToggleSwitch("TRP")}
            >
              <span
                className={`${isToggleSwitch == "TRP" ? "text-[#F6F6F6]" : "text-[#1F4B7F]"
                  }  text-[1.3vw]`}
              >
            ...
            <div className="py-[2vw]">
              {Travel.map((trp) => (
                <div className="flex items-center gap-x-[2vw] py-[0.5vw]">
                  <div className="w-[2vw] h-[2vw] ">{trp.img}</div>
                  <div className="flex flex-col ">
                    <div className="text-[1.1vw] text-[#1F4B7F] font-semibold">
                      {trp.parent}
                    </div>
                    <div className="text-[1.1vw] text-[#1F4B7F]">{trp.child}</div>
                    <div className="text-[1.1vw] text-[#1F4B7F]">{trp.child1}</div>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="bg-[#F6F6F6] h-auto px-[5vw]">
          ...
          {isToggleSwitch == "CDCP" ? (
            ...
            <div className="py-[2vw]">
              {Travel.map((trp) => (
                <div className="flex items-center gap-x-[2vw] py-[0.5vw]">
                  <div className="w-[4vw] h-[4vw] ">{trp.img}</div>
                  <div className="flex flex-col ">
                    <div className="text-[2.2vw] text-[#1F4B7F] font-semibold">
                      {trp.parent}
                    </div>
                    <div className="text-[2.2vw] text-[#1F4B7F]">{trp.child}</div>
                    <div className="text-[2.2vw] text-[#1F4B7F]">{trp.child1}</div>
                  </div>
                </div>
              ))}
            </div>
