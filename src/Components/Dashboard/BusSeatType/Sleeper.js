...
import unisex_book from "../../../assets/unisex_book.png";
...
function Sleeper({ busdetails, seatplatform, type, busprice, imageurl }) {
  const lowerseatlist = [
    {
      rowlist: [
        {
  ...
  return (
    <div className="px-[0.5vw]">
      ...
      >
        <div className="grid grid-cols-2 h-[45vw]  w-full bg-[#EEEDED] rounded-b-[0.5vw]">
