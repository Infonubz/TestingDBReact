                    ...
                    <div className="row-span-4">
                      <div className="grid grid-cols-5 h-full w-full flex-col items-center">
                        <div className="col-span-1 flex-col flex items-center justify-center pt-[0.5vw]">
                          <label className="text-[1.2vw] text-[#868686] font-semibold">
                            {dayjs(item?.departure_date_time).format("DD MMM")}
                          </label>
                          <label className="text-[1.7vw] text-[#1F487C] font-bold">
                        ...
                        <div className=" col-span-3 h-full relative w-full flex items-center justify-center">
                          ...
                          <div
                            className="bg-[#1F487C]  relative h-[2.8vw] flex w-[7.5vw] rounded-tl-[1vw] rounded-tr-[1vw] rounded-bl-[0.5vw] rounded-br-[0.5vw] text-white text-[1.2vw] font-bold justify-center items-center"
                            // style={{
                            //   zIndex: 2,
                            // }}
                          >
                            {item.time_duration}
                            <div
                              className="bg-[#1F487C] absolute bottom-[-1vw] left-[0.8vw] h-[2vw] w-[2vw] rounded-full flex items-center justify-center "
                              // style={{
                              //   zIndex: 1,
                              // }}
                            >
                            ...
                            <div className="bg-[#1F487C] absolute bottom-[-1vw] right-[0.8vw] h-[2vw] w-[2vw] rounded-full flex items-center justify-center ">
                              <div className="bg-white  h-[1vw] w-[1vw] rounded-full"></div>
                            </div>
                          </div>
                          <FaAngleRight
                ...
                <div className="">
                  <div className="grid grid-rows-4">
                    <div className="row-span-1">
                      <div className="text-[#1F487C] font-semibold text-[1.2vw] px-[1vw]">
                        {item.bus_type}
                      </div>
                    </div>
                    <div className="row-span-3  flex flex-col">
                      ...
                      <div className=" w-[20vw] px-[4vw] flex items-end py-[1vw] absolute right-0">
                        <div className="absolute top-[0.5vw] left-[3vw]">
                          <p className="absolute left-[3vw] top-[-1.5vw] w-[8vw]  text-[1.5vw] text-[#1F487C]">
                            Starting @
                          </p>
                          {/* <div className="relative flex items-center ">
                          ...
                          {/* </div> */}
                          <div className="relative flex items-center">
                            <div className="absolute top-[1.2vw] left-0 w-[13vw] h-[4vw] bg-[#1F487C]">
                              <p className=" absolute top-[0.2vw] left-[3vw] font-bold text-[2.5vw] text-white">
                                ₹ {Math.round(item.lowest_price.price)}
                              </p>
                            </div>
                            <div className="absolute top-[-1vw] left-[-3vw] w-[4vw] h-[8vw] bg-white rounded-r-full "></div>
                          ...
                          <button
                            className="absolute top-[6vw] left-[2vw] w-[9vw] h-[2.2vw] border-[0.2vw] border-dashed border-[#1F487C] text-[#1F487C] text-[1.1vw] font-semibold rounded-[0.3vw]"
