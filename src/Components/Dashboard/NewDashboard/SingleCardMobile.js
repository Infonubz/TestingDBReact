                  ...
                  <div className="col-span-2">
                    <div className=" flex flex-col py-[1.5vw] justify-center items-center gap-y-[0.5vw]">
                      <div className="flex gap-[1vw]">
                        <div className="text-[#1F487C] text-[3.2vw]">
                          {item.seats_avalble.avlWindow}
                        </div>
                        <div className="text-[#1F487C] text-[3.2vw] w-full">
                          Windows Seat
                        </div>
                      </div>
                  ...
                  <div className="col-span-4 relative">
                    ...
                    <div className="grid grid-cols-4 h-full w-full">
                      <div className="col-span-1 flex-col flex items-center justify-center">
                        ...
                        <label className="text-[3.5vw] text-[#1F487C] font-bold">
                ...
                <div className="px-[1vw] ">
                  <div className="flex items-center gap-[0.5vw] pt-[2.5vw] pb-[0.5vw]">
                    ...
                    <div className="flex items-center px-[1vw] gap-[1vw]">
                      ...
                      >
                        <div>
                          <MdMyLocation size="3vw" color="#1F487C" />
                        </div>
                        <div>
                          <BiPlug color="#1F487C" size="3vw " />
                        </div>
                        <div>
                          <BiSolidBlanket color="#1F487C" size="3vw" />
                        </div>
                        <div>
                          <p className="text-[3vw] text-[#1F487C]">
                            +{item.amenities.length - 3}
                          </p>
                        </div>
                        <div>
                          {dropDown === `liveTracking${index}` ? (
                            <IoIosArrowUp color="#1F487C" size="3vw" />
                          ) : (
                            <IoIosArrowDown color="#1F487C" size="3vw" />
                          )}
                        </div>
                      </div>
                      ...
                      >
                        <div className="text-[#1F487C] text-[2.2vw]">
